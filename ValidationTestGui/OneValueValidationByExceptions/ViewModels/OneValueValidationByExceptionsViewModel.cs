// -----------------------------------------------------------------------
// <copyright file="OneValueSortedValidationByValidationRulesViewModel.cs" company="Anori Soft">
...
namespace Anori.Common.WPF.Validations.ValidationTestGui.OneValueValidationByExceptions.ViewModels
{
    ...
    public class OneValueValidationByExceptionsViewModel : Binders.Bindable, INotifyDataErrorInfo, IDisposable
    {
        /// <summary>
        ///     The value1
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueValidationByExceptionsViewModel" /> class.
        /// </summary>
        public OneValueValidationByExceptionsViewModel()
        {
            this.Validator = new ValidatorBuilder<OneValueValidationByExceptionsViewModel>().Build(this);
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueValidationByExceptionsViewModel> Validator { get; }
