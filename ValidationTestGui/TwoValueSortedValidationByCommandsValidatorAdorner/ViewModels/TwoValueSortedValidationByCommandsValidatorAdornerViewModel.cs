// -----------------------------------------------------------------------
// <copyright file="TwoValueSortedValidationByCommandsValidatorAdornerViewModel.cs" company="bfa solutions ltd">
// Copyright (c) bfa solutions ltd. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace Bfa.Common.WPF.Validations.ValidationTestGui.TwoValueSortedValidationByCommandsValidatorAdorner.ViewModels
{
    using System;
    ...
    /// <summary>
    ///     The two value sorted validation by commands validator adorner view model
    /// </summary>
    ...
    public class TwoValueSortedValidationByCommandsValidatorAdornerViewModel : Binders.Bindable,
                                                                               ...
                                                                               IComparerTwoValues
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TwoValueSortedValidationByCommandsValidatorAdornerViewModel" /> class.
        /// </summary>
        public TwoValueSortedValidationByCommandsValidatorAdornerViewModel()
        {
            var builder = new ValidatorBuilder<TwoValueSortedValidationByCommandsValidatorAdornerViewModel>();
        ...
        ///     The validator.
        /// </value>
        public Validator<TwoValueSortedValidationByCommandsValidatorAdornerViewModel> Validator { get; }
