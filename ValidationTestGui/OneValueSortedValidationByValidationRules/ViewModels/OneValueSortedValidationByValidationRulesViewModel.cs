...
namespace Anori.Common.WPF.Validations.ValidationTestGui.OneValueSortedValidationByValidationRules.ViewModels
{
    using System;
    ...
    public class OneValueSortedValidationByValidationRulesViewModel : Binders.Bindable,
