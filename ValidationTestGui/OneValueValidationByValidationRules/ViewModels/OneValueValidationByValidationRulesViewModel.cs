// -----------------------------------------------------------------------
// <copyright file="OneValueValidationByValidationRulesViewModel.cs" company="bfa solutions ltd">
// Copyright (c) bfa solutions ltd. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueValidationByValidationRules.ViewModels
{
    using System;
    ...
    /// <summary>
    ///     One value validation by validation rules view model class
    /// </summary>
    /// <seealso cref="Bfa.Common.Binders.Bindable" />
    /// <seealso cref="System.ComponentModel.INotifyDataErrorInfo" />
    /// <seealso cref="System.IDisposable" />
    public class OneValueValidationByValidationRulesViewModel : Binders.Bindable, INotifyDataErrorInfo, IDisposable
    {
        /// <summary>
        ///     The value1
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueValidationByValidationRulesViewModel" /> class.
        /// </summary>
        public OneValueValidationByValidationRulesViewModel()
        {
            this.Validator = new ValidatorBuilder<OneValueValidationByValidationRulesViewModel>().Build(this);
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueValidationByValidationRulesViewModel> Validator { get; }
