...
namespace Anori.Common.WPF.Validations.ValidationTestGui
{
    ...
    public class SortedValidationErrorCollectionByPriorityConverter : MarkupExtension, IValueConverter
    {
        /// <summary>
        ///     The instance
        /// </summary>
        private static readonly Lazy<IValueConverter> Instance =
            new Lazy<IValueConverter>(() => new SortedValidationErrorCollectionByPriorityConverter());
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var sorted = new SortedObservableCollection<int, ValidationError>(
                message => ((message.ErrorContent is IWarning) ? 1 : 0));
        ...
        private void OnCollectionChanged(NotifyCollectionChangedEventArgs args, IList<ValidationError> sorted)
        {
            switch (args.Action)
            {
