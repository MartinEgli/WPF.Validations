...
namespace Anori.Common.WPF.Validations.ValidationTestGui.TwoValueValidationByCommands.ViewModels
{
    using System;
    ...
    public class TwoValueValidationByCommandsViewModel : Binders.Bindable, INotifyDataErrorInfo, IDisposable
    {
        /// <summary>
        ///     The object name
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TwoValueValidationByCommandsViewModel" /> class.
        /// </summary>
        public TwoValueValidationByCommandsViewModel()
        {
            this.Validator = new ValidatorBuilder<TwoValueValidationByCommandsViewModel>().Build(this);
        ...
        ///     The validator.
        /// </value>
        public Validator<TwoValueValidationByCommandsViewModel> Validator { get; }
