...
namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueValidationByCommandsValidatorToUpper.ViewModels
{
                                                                         ...
                                                                         IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueValidationByCommandsValidatorToUpperViewModel" /> class.
        /// </summary>
        public OneValueValidationByCommandsValidatorToUpperViewModel()
        {
            var builder = new ValidatorBuilder<OneValueValidationByCommandsValidatorToUpperViewModel>();
            builder.AddRule("Value1", new ToUpperRule("ToUpper", "Value1"), true);
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueValidationByCommandsValidatorToUpperViewModel> Validator { get; }
