// -----------------------------------------------------------------------
// <copyright file="RegexValidationRule.cs" company="bfa solutions ltd">
...
namespace Bfa.Common.WPF.Validations
{
    ...
    public class RegexValidationRule : ValidationRule
    {
        ...
        public RegexValidationRule([NotNull] string regexPattern)
        {
        ...
        public RegexValidationRule(string regexPattern, [NotNull] string errorMessage)
            : this(regexPattern)
        {
        ...
        public RegexValidationRule(string regexPattern, string errorMessage, RegexOptions regexOptions)
            : this(regexPattern)
        {
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            {
                result = new ValidationRuleError(this.ErrorMessage).ToValidationResult();
            }
