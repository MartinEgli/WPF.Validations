// -----------------------------------------------------------------------
// <copyright file="OneValueSortedValidationByCommandsAndValidatorViewModel.cs" company="bfa solutions ltd">
// Copyright (c) bfa solutions ltd. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueSortedValidationByCommandsValidator.ViewModels
{
    using System;
    ...
    public class OneValueSortedValidationByCommandsValidatorViewModel : Binders.Bindable,
                                                                        ...
                                                                        IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueSortedValidationByCommandsValidatorViewModel" /> class.
        /// </summary>
        public OneValueSortedValidationByCommandsValidatorViewModel()
        {
            var builder = new ValidatorBuilder<OneValueSortedValidationByCommandsValidatorViewModel>();
            builder.AddRule(
                "Value1",
            ...
            builder.AddRule("Value1", new MaxLengthRule("MaxLength", "Value1", 50));
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueSortedValidationByCommandsValidatorViewModel> Validator { get; }
