// -----------------------------------------------------------------------
// <copyright file="OneValueSortedValidationByCommandsViewModel.cs" company="bfa solutions ltd">
// Copyright (c) bfa solutions ltd. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueSortedValidationByCommands.ViewModels
{
    using System;
    ...
    public class OneValueSortedValidationByCommandsViewModel : Binders.Bindable, INotifyDataErrorInfo, IDisposable
    {
        /// <summary>
        ///     The value1
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueSortedValidationByCommandsViewModel" /> class.
        /// </summary>
        public OneValueSortedValidationByCommandsViewModel()
        {
            this.Validator = new ValidatorBuilder<OneValueSortedValidationByCommandsViewModel>().Build(this);
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueSortedValidationByCommandsViewModel> Validator { get; }
