// -----------------------------------------------------------------------
// <copyright file="OneValueSortedLocalisedValidationByCommandsWindow.xaml.cs" company="bfa solutions ltd">
...
namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueSortedLocalizedFallbackValidationByCommands
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueSortedLocalizedPlaceholderFallbackValidationByCommands.OneValueSortedLocalizedFallbackValidationByCommandsWindow" />
        ///     class.
        /// </summary>
