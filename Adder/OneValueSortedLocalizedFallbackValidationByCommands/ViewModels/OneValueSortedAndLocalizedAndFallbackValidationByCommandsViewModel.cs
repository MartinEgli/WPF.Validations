...
namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueSortedLocalizedFallbackValidationByCommands.ViewModels
{
                                                                           ...
                                                                           IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueSortedLocalizedFallbackValidationByCommandsViewModel" /> class.
        /// </summary>
        public OneValueSortedLocalizedFallbackValidationByCommandsViewModel()
        {
            this.Validator =
                new ValidatorBuilder<OneValueSortedLocalizedFallbackValidationByCommandsViewModel>().Build(this);
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueSortedLocalizedFallbackValidationByCommandsViewModel> Validator { get; }
