// -----------------------------------------------------------------------
// <copyright file="OneValueValidationByCommandsValidatorCancelViewModel.cs" company="bfa solutions ltd">
// Copyright (c) bfa solutions ltd. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace Bfa.Common.WPF.Validations.ValidationTestGui.OneValueValidationByCommandsValidatorCancel.ViewModels
{
    using System;
    ...
    /// <summary>
    ///     OneValueValidationByCommandsValidatorCancelViewModel class
    /// </summary>
    /// <seealso cref="Bfa.Common.Binders.Bindable" />
    /// <seealso cref="System.ComponentModel.INotifyDataErrorInfo" />
    /// <seealso cref="System.IDisposable" />
    public class OneValueValidationByCommandsValidatorCancelViewModel : Binders.Bindable,
                                                                        ...
                                                                        IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OneValueValidationByCommandsValidatorCancelViewModel" /> class.
        /// </summary>
        public OneValueValidationByCommandsValidatorCancelViewModel()
        {
            var builder = new ValidatorBuilder<OneValueValidationByCommandsValidatorCancelViewModel>();
            builder.AddRule(
                "Value1",
                new RegexRule("NoSpaces", "Value1") { ErrorMessage = "No Spaces", RegexPattern = @"^\S*$" },
                true);
        ...
        ///     The validator.
        /// </value>
        public Validator<OneValueValidationByCommandsValidatorCancelViewModel> Validator { get; }
